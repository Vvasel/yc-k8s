...
2. **Сетевая топология:** Создает VPC сеть и подсеть в зоне `ru-central1-a` с выделенными пулами IP для подов и сервисов.
...
git clone [https://github.com/ВАШ_НИК/ВАШ_РЕПО.git](https://github.com/ВАШ_НИК/ВАШ_РЕПО.git)
cd ВАШ_РЕПО# yc-k8s
